...
function setup() {
	...
	//Create the Bodies Here.
	 ...
	 dustbin1=new Dustbin(width/1.4,height-105,10,180)
	 dustbin2=new Dustbin(width/1.19,height-105,10,180)
	 dustbin3=new Dustbin(width/1.286,height-20,140,10)
